...
const $robotScore = document.querySelector("#computerScore");
...
const UI = {
  init: function() {
      ...
      // preload some images
      (new Image()).src = "images/rock.png";
      (new Image()).src = "images/paper.png";
      (new Image()).src = "images/scissors.png";
...
stopAnimateMessage: function() {
  ...
  setComputerScore: function (score) {
  ...
  setRobotGesture: function (gesture) {
    switch (gesture) {
      case "rock":
        $robotHand.src = "images/rock.png";
        break;
      case "paper":
        $robotHand.src = "images/paper.png";
        break;
      case "scissors":
        $robotHand.src = "images/scissors.png";
        break;
      default:
        $robotHand.src = "";
    }
